...
if (IS_DIRECTORY "${EXPECTED_OUTPUT}")
    ...
    if ( NOT TEST_MERGE_OUTPUT )
        file(GLOB_RECURSE expected_files LIST_DIRECTORIES FALSE ${EXPECTED_OUTPUT}/*)
    else ()
        execute_process(COMMAND /Users/cmiss/ocmerge/build/ocmerge -n ${EXPECTED_OUTPUT}/*.exnode -o ${EXPECTED_OUTPUT}/merged.exnode)
        execute_process(COMMAND /Users/cmiss/ocmerge/build/ocmerge -e ${EXPECTED_OUTPUT}/*.exelem -o ${EXPECTED_OUTPUT}/merged.exelem)
        execute_process(COMMAND /Users/cmiss/ocmerge/build/ocmerge -n ${TEST_OUTPUT}/*.exnode -o ${TEST_OUTPUT}/merged.exnode)
        execute_process(COMMAND /Users/cmiss/ocmerge/build/ocmerge -e ${TEST_OUTPUT}/*.exelem -o ${TEST_OUTPUT}/merged.exelem)
