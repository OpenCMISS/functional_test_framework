...
macro(add_functional_test TEST_DESCRIPTION_FILE)
	...
	if (DEFINED ${_prefix}MERGE_OUTPUT)
            set(${_prefix}${TEST_COUNT}_MERGE_OUTPUT ${${_prefix}MERGE_OUTPUT})
        else ()
            set(${_prefix}${TEST_COUNT}_MERGE_OUTPUT FALSE)
        endif ()
